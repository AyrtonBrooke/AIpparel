      ...
      body: Stack(
        children: [
          PageView(
            ...
            children:  const [
              onBoardingPage(animationAsset: AImages.onBoardingImage1,
                title: ATexts.onBoardingTitle1,
                subTitle: ATexts.onBoardingSubTitle1,
              ),
              onBoardingPage(animationAsset: AImages.onBoardingImage2,
                title: ATexts.onBoardingTitle2,
                subTitle: ATexts.onBoardingSubTitle2,
              ),
              onBoardingPage(animationAsset: AImages.onBoardingImage3,
